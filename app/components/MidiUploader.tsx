...
const MidiUploader = () => {
  ...
  return (
    <div id="midi-uploader" className="flex flex-col items-center justify-center p-5 rounded-lg shadow-md max-w-md mx-auto h-[80vh] w-[40vw] bg-gradient-to-r from-blue-600 to-blue-500 font-montserrat font-bold portrait:mt-[125vh] portrait:w-[80vw]">
